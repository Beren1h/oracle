...
class Dole extends Component {
    ...
    async post(parent) {
        ...
        this.state.pendings.forEach((pending) => {
            const transaction0 = transactions.find(t => t.containerId == pending.envelope._id);
            const transaction1 = transactions.find(t => t.containerId == parent.containerId);
    ...
    render() {
        return <div>
            <h3>dole - root</h3>
            <Envelopes pendings={this.state.pendings} displayPending={this.displayPending} />
            <Pending pendings={this.state.pendings} hidePending={this.hidePending} />
