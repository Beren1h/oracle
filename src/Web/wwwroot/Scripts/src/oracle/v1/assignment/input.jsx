    ...
    render() {
        return <div className={'detail'}>
                    ...
                    this.state.assignments.map((loop, index) => {
                        return <div key={index}>
                            <input
                                ...
                                id="assignment-date"
                                type="text"
                                value={moment(loop.date).format('MM-DD-YYYY')}
                                disabled={true}
                            />   
                            <NumberFormat
            ...
            <div className={'actions'}>
                <div>
                    <label className={'notice'}>{this.props.envelope}</label>
                    <div>
                        <a className={classNames({
                            'hidden': !this.state.isDirty
                        })} onClick={this.onPost}>submit</a>
                    </div>
                    <label>{this.state.result.status}</label>
                    <label className={'error'}>{this.state.result.message}</label>                            
                </div>
            </div>
        </div>;
    }
